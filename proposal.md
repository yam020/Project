...
The Covid-19 data: case rate, death rate, test rate, hospitalized rate, percentage postive rate.
<br> By entering the desired zipcode/boroughs, users are able to see the trend graphs of Covid-19 case/death/test/hospitalized rate in that particular area. The webapp also provides a map of new york that display the above described data in New York City. The map is divided by zipcode. Users can move their mouse over to the interested area to check the Covid-19 situation.
...
<br> **streamlit** is used to for user interface. (in planning)
